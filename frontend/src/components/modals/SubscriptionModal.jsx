                        ...
                        <div className="border-2 border-indigo-600 rounded-3xl p-8 flex flex-col relative bg-white shadow-xl max-w-md w-full">
                            ...
                            <div className="mb-6">
                                <h3 className="text-xl font-bold text-indigo-600 mb-2 flex items-center justify-center">
                                    <Crown className="w-5 h-5 mr-2 fill-current" /> {t('subscription.plan_name')}
                                </h3>
                                <div className="text-4xl font-black text-gray-900">$29 <span className="text-lg text-gray-400 font-medium">{t('subscription.per_month')}</span></div>
                            </div>
